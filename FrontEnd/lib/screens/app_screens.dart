...
//         // Redirect customers to the styled BuyerHomeScreen
//         return const _CustomerRedirect();
//       },
//     );
//   }
// }

// class _CustomerRedirect extends StatefulWidget {
//   const _CustomerRedirect();

//   @override
//   State<_CustomerRedirect> createState() => _CustomerRedirectState();
// }

// class _CustomerRedirectState extends State<_CustomerRedirect> {
//   @override
//   void initState() {
//     super.initState();
...
// Customers land directly on BuyerHomeScreen — no named route push,
// so the nav stack stays clean and logout (which calls popUntil isFirst)
// brings them back to RootScreen which then shows AuthScreen.
class _CustomerRedirect extends StatelessWidget {
  const _CustomerRedirect();

  @override
  Widget build(BuildContext context) {
    // We render BuyerHomeScreen inline as the root widget for customers.
    // This means there is nothing below it to pop to, so logout works
    // correctly: popUntil(isFirst) lands on RootScreen → AuthScreen.
